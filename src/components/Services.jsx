    ...
    <div onClick={onClose} style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding: '2rem' }}>
          <p style={{ color: colors.textSub, lineHeight: '1.8', marginBottom: '2rem', fontSize: '0.95rem' }}>
            {service.longDescription}
          </p>

          <h3 style={{
            fontFamily: 'Cormorant Garamond, serif',
            fontSize: '1.5rem', marginBottom: '1rem', color: '#1A6DFF',
          }}>
            Nos tarifs
          </h3>
            ...
            {service.details.map((item, i) => (
              <div key={i} style={{
                ...
                <div>
                  ...
                  <p style={{ color: colors.textSub, fontSize: '0.75rem', marginTop: '0.2rem' }}>⏱ {item.duree}</p>
                </div>
                <span style={{
                  color: '#1A6DFF', fontFamily: 'Cormorant Garamond, serif',
          ...
          <a href="#reservation" onClick={onClose} style={{
            ...
            boxShadow: '0 0 30px rgba(26,109,255,0.3)',
          }}>
            Réserver ce service
          </a>
        </div>
    ...
    <>
      ...
      >
        ...
        <div style={{ position: 'relative', height: '180px', overflow: 'hidden' }}>
          ...
          <span style={{ position: 'absolute', bottom: '1rem', left: '1rem', fontSize: '2rem' }}>
            {service.icon}
          </span>
        </div>
        ...
        <div style={{ padding: '1.5rem' }}>
          <h3 style={{
            fontFamily: 'Cormorant Garamond, serif',
            fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.6rem',
            color: hovered ? '#1A6DFF' : colors.text,
