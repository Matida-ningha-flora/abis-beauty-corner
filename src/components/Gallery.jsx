...
function GalleryItem({ url, label, slug, index, visible }) {
  ...
  return (
    <div
      ...
      onClick={() => router.push(`/galerie/${slug}`)}
    ...
    >
      ...
      <div style={{
        ...
        <div>
          ...
          {/* Indicateur "voir la galerie" au hover */}
          <span style={{
            fontSize: '0.72rem', letterSpacing: '0.12em', color: '#1A6DFF',
