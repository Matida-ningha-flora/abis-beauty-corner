    ...
    <section style={{
      ...
      <div style={{ textAlign: 'center', zIndex: 10, padding: '0 2rem' }}>
        ...
        <div style={{
          ...
          <div style={{ width: '80px', height: '1px', background: 'linear-gradient(to right, transparent, #1A6DFF)' }} />
          <span style={{ color: '#1A6DFF', display: 'inline-block', animation: 'float 2s ease-in-out infinite' }}>✦</span>
          <div style={{ width: '80px', height: '1px', background: 'linear-gradient(to left, transparent, #1A6DFF)' }} />
        </div>
